...
PARAMETERS: p_file TYPE localfile DEFAULT 'C:\Users\al24361\OneDrive - Alliander NV\Documents\SAP\SAP GUI\test1.xls'.
*PARAMETERS: p_pword TYPE char8 DEFAULT 'mike'.
...
** Close the file
  ...
  CALL METHOD OF e_work 'SAVEAS'
    EXPORTING
      ...
      #3 = 'mike'       "" Password
      #4 = 'mike'.      "" Reserved for Password</b>
